...
if __name__ == "__main__":
    ...
    create_dataset(sourcefile="idiot_analogies.txt",      outfile="questions_idiot_analogies.txt",   mode="analogies")
    create_dataset(sourcefile="idiot_doesnt_match.txt", outfile="questions_idiot_doesnt_match.txt", mode="doesnt_match")
